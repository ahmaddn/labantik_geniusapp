...
<template>
    <div class="app-layout theme-pretest">
        <!-- ░░ BACKGROUND ░░ -->
        <div class="bg-scene">
...
.app-layout {
    ...
    /* Theme Variables - Royal Blue (Pretest) */
    --theme-color-primary: #0ea5e9;
    --theme-color-primary-hover: #0284c7;
    --theme-color-primary-active: #0369a1;
    
    --theme-bg-gradient: linear-gradient(135deg, #e0f7fa 0%, #e1f5fe 40%, #e0f2fe 100%);
    --theme-particle-1: radial-gradient(circle, #bae6fd, #7dd3fc);
    --theme-particle-2: radial-gradient(circle, #c7d2fe, #818cf8);
    --theme-particle-3: radial-gradient(circle, #e0f2fe, #93c5fd);
    --theme-particle-4: radial-gradient(circle, #ccfbf1, #2dd4bf);
    --theme-particle-5: radial-gradient(circle, #ede9fe, #a78bfa);
}
