...
// Group incorrect questions by quiz type for the breakdown
        ...
        <div v-for="(questions, type) in incorrectByType" :key="type" class="review-type-group">
          ...
          <div class="review-questions">
            ...
            >
              ...
              <!-- Drag drop: show item placements -->
                ...
                <div class="rq-dd-review">
                  <div class="rq-answer-row wrong">
                    ...
                    <div class="rq-dd-items">
                      <span
                        v-for="(groupName, itemLabel) in q.user_answer_map"
                        :key="itemLabel"
                        class="rq-dd-chip wrong-chip"
                      >{{ itemLabel }} → {{ groupName }}</span>
                    </div>
                  </div>
                  <div class="rq-answer-row correct-row">
                    ...
                    <div class="rq-dd-items">
                      <span
                        v-for="(groupName, itemLabel) in q.correct_answer_map"
                        :key="itemLabel"
...
.score-mission {
  font-family: 'Righteous', cursive;
  font-size: 20px; color: #1e3a8a; text-align: center;
}
.score-verdict {
...
.bk-badge {
  font-size: 10.5px; font-weight: 900; color: var(--bc);
  text-transform: uppercase; letter-spacing: 0.4px;
}
.bk-score { font-family: 'Righteous', cursive; font-size: 18px; }
.bk-bar {
  height: 5px; background: rgba(0,0,0,0.08); border-radius: 10px; overflow: hidden;
}
...
.rq-text {
  font-size: 13px; font-weight: 700; color: #1e293b; line-height: 1.5;
  flex: 1;
}
...
.rq-dd-chip {
  font-size: 11px; font-weight: 700; border-radius: 6px; padding: 3px 9px;
}
