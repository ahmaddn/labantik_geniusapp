                ...
                <Transition name="pg">
                    <div v-if="phase === 'done'" class="dcard">
                        ...
                        <div class="dcard-inner">
                            ...
                            <p class="done-sub">
                                Kamu telah menyelesaikan pretest dengan luar
                                biasa.<br />
                                Sekarang saatnya memulai petualangan misi
                                belajar!
                            </p>
                        </div>
                    </div>
...
.bg-img {
    position: absolute;
    inset: 0;
    background: url("/images/templates/background-pretest.png") center/cover
        no-repeat;
}
.bg-tint {
    position: absolute;
