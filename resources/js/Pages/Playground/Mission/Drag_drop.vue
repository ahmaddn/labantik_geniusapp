...
const onTouchStart = (item, e) => {
    ...
    Object.assign(tClone.style, {
        ...
        borderRadius: "12px",
        boxShadow: "0 12px 32px rgba(29,78,216,.3)",
        transition: "none",
    });
    ...
    <div class="dd" @touchmove.prevent="onTouchMove" @touchend="onTouchEnd">
        ...
        <div class="dd-progress">
            <div class="dd-prog-row">
                ...
                <span class="dd-prog-count"
                    >{{ placedCount }} / {{ totalCount }}</span
                >
            </div>
                ...
                <TransitionGroup name="dd-place">
                    ...
                    >
                        ...
                        <div class="dd-placed-status">
                            <CheckCircle2
                                v-if="item.correctGroupId === zone.id"
                                :size="11"
                                :stroke-width="2.5"
                            />
...
.dd-zone--over {
    border-style: solid;
    box-shadow:
        0 0 0 3px color-mix(in srgb, var(--zbadge) 20%, transparent),
...
.dd-placed {
    ...
    min-width: 64px;
    position: relative;
    animation: dd-popin 0.28s cubic-bezier(0.34, 1.56, 0.64, 1);
}
.dd-placed-visual {
    width: 44px;
    height: 44px;
...
.dd-placed--ok .dd-placed-status {
    color: #22c55e;
}
.dd-placed--err .dd-placed-status {
    color: #ef4444;
}
...
.dd-placed:hover .dd-placed-remove {
    opacity: 1;
}
.dd-placed-remove:hover {
...
.dd-place-enter-active {
    animation: dd-popin 0.28s cubic-bezier(0.34, 1.56, 0.64, 1);
}
.dd-place-leave-active {
    transition: all 0.15s ease;
}
.dd-place-leave-to {
    opacity: 0;
