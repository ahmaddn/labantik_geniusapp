...
const typeMeta = (t) =>
    TYPE_META[t] || { label: t, color: "#64748b", bg: "#f1f5f9" };
    ...
    <div class="root">
        ...
        <div class="body" :class="{ 'body--on': ready }">
            ...
            <section class="main" :class="{ 'main--on': ready }">
                        ...
                        <div class="icard-head">
                            ...
                            <div class="icard-head-inner">
                                ...
                                <p class="icard-sub">
                                    {{
                                        quiz.description ??
                                        "Jawab semua soal untuk mengukur kemampuanmu setelah menyelesaikan semua misi!"
                                    }}
                                </p>
                            </div>
                        </div>
                ...
                <Transition name="pg">
                    <div
                        v-if="phase === 'quiz' && currentQ"
                        class="qcard"
                        :class="{ 'qcard--shake': shakeActive }"
                    >
                        <div
                            class="qcard-bar"
                            :style="{ background: typeMeta(quizType).color }"
                        ></div>
                        ...
                        <div class="qcard-head">
                            ...
                            <div class="qcard-head-inner">
                                ...
                                <span class="qcard-mission">{{
                                    module.name
                                }}</span>
                                <div class="qcard-counter">
                                    <span class="qcard-counter-num">{{
                                        currentIdx + 1
                                    }}</span>
                                    <span class="qcard-counter-sep">/</span>
                                    <span class="qcard-counter-tot">{{
                                        totalQ
                                    }}</span>
                                </div>
                            </div>
                        ...
                        <div class="qcard-title-row">
                            ...
                            <div
                                v-if="isQuestionAnswered(currentQ)"
                                class="q-answered-badge"
                            >
                ...
                <Transition name="pg">
                    <div v-if="phase === 'done'" class="dcard">
                        ...
                        <div class="dcard-inner">
                            ...
                            <p class="done-sub">
                                Kamu telah menyelesaikan posttest dengan luar
                                biasa.<br />
...
.bg-img {
    position: absolute;
    inset: 0;
    background: url("/images/templates/background-posttest.png") center/cover
        no-repeat;
}
.bg-tint {
    position: absolute;
...
.pose-swap-enter-active {
    transition:
        opacity 0.4s ease,
        transform 0.45s cubic-bezier(0.34, 1.56, 0.64, 1);
}
.pose-swap-leave-active {
    transition: opacity 0.2s ease;
    position: absolute;
    bottom: 0;
}
.pose-swap-enter-from {
    opacity: 0;
...
.icard {
    ...
    box-shadow:
        0 4px 0 var(--blue-soft),
        0 10px 32px rgba(59, 130, 246, 0.1);
}
.icard-head {
...
.istat--yellow .istat-val {
    color: #92400e;
}
.istat--yellow .istat-lbl {
    color: #d97706;
}
.istat--blue {
    background: #f0fdf9;
...
.istat--blue .istat-val {
    color: #065f46;
}
.istat--blue .istat-lbl {
    color: #059669;
}
.istat-icon {
    width: 46px;
...
.dcard {
    ...
    box-shadow:
        0 4px 0 #6ee7b7,
        0 10px 32px rgba(52, 211, 153, 0.15);
}
.dcard-confetti {
    position: absolute;
    inset: 0;
...
.trophy-ring {
    ...
    align-items: center;
    justify-content: center;
    box-shadow: 0 5px 22px rgba(52, 211, 153, 0.26);
    animation: tPop 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) both 0.08s;
}
@keyframes tPop {
    from {
...
.done-party {
    animation: spFloat 1.8s ease-in-out infinite;
}
.done-sub {
    font-size: 13.5px;
    font-weight: 700;
...
.fbtn--yellow:hover:not(:disabled) {
    transform: translateY(-2px);
    box-shadow: 0 5px 16px rgba(37, 99, 235, 0.5);
}
@keyframes spin {
