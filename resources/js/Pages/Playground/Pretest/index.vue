...
const BUBBLES_DONE = [
    ...
    "Kerja bagus! Mantap sekali!",
    "Pretest selesai! Hebat!",
    "Jempol buat kamu!",
];
...
const INSTR_ITEMS = [
    ...
    { color: "blue",   icon: Timer,        text: "Kerjakan sesuai waktu yang ada." },
    { color: "red",    icon: ChevronRight, text: "Klik Berikutnya setelah memilih." },
];
</script>
        ...
        <div class="body" :class="{ 'body--on': ready }">
            ...
            <aside class="sidebar" :class="{ 'sidebar--on': ready }" @click="rotateBubble">
                ...
                <div class="mascot-wrap">
                    ...
                    <!-- key=phase agar Vue re-mount img saat pose ganti → trigger transition -->
            ...
            <section class="main" :class="{ 'main--on': ready }">
                ...
                <div v-if="phase === 'intro'" class="icard">
                    ...
                    <div class="icard-head">
                        ...
                        <div class="icard-head-inner">
                            ...
                            <p class="icard-sub">
                                {{ quiz?.description ?? 'Jawab semua soal dengan sebaik-baiknya untuk mengukur pemahamanmu!' }}
                            </p>
                        </div>
                    </div>

                    <!-- 3 stat tiles: Merah · Kuning · Biru -->
                    <div class="icard-stats">
                        ...
                        <div class="istat istat--yellow">
                            <div class="istat-icon">
                                <Clock :size="19" :stroke-width="1.8"/>
                            </div>
                        ...
                        <div class="istat istat--blue">
                            <div class="istat-icon">
                                <Award :size="19" :stroke-width="1.8"/>
                            </div>
                ...
                <div v-if="phase === 'done'" class="dcard">
                    ...
                    <div class="dcard-inner">
                        ...
                        <h2 class="done-ttl">Tantangan Selesai!</h2>
                        ...
                        <p class="done-sub">
                            ...
                            Lanjutkan petualangan belajarmu sekarang!
                        </p>
                    </div>
                </div>
                </Transition>
...
/* Speech bubble — color shifts per phase */
.bubble {
...
/* Mascot image — pose swap transition */
...
.icard {
    ...
    /* Shadow bawah pakai biru soft, bukan biru pekat */
...
.icard-hdeco {
    position: absolute;
    border-radius: 50%;
    background: rgba(255,255,255,.08);   /* lebih subtle */
    pointer-events: none;
}
...
/* ═══════════════════════════════════════════════════════
   3-STAT TILES  (Merah · Kuning · Biru)
   → Diganti: Merah · Kuning · Hijau
   Warna background & icon lebih pastel/muted
═══════════════════════════════════════════════════════ */
.icard-stats {
    display: grid;
...
/* ═══════════════════════════════════════════════════════
   PETUNJUK PENGERJAAN
   4 baris dengan warna soft: Merah · Kuning · Hijau · Biru
═══════════════════════════════════════════════════════ */
...
.instr-row--red .instr-num  {
    background: #F87171;
    color: #fff;
}
.instr-row--red .instr-ico  { color: #F87171; }

/* ── Baris 2: Kuning/Amber ── */
.instr-row--yellow {
    background: #FFFDF0;
    border-color: #FDE68A;
}
.instr-row--yellow .instr-num {
    background: #FBBF24;
    color: #fff;
}
.instr-row--yellow .instr-ico { color: #D97706; }

/* ── Baris 3: Hijau (ganti dari biru agar 4 warna terwakili) ── */
.instr-row--green  {
    background: #F0FDF9;
    border-color: #A7F3D0;
}
.instr-row--green .instr-num {
    background: #34D399;
    color: #fff;
}
...
/* ═══════════════════════════════════════════════════════
   START BUTTON  — biru solid, bukan terlalu terang
═══════════════════════════════════════════════════════ */
.icard-start-btn {
    display: flex;
    align-items: center;
    ...
    color: #fff;
    cursor: pointer;
    /* Bottom shadow pakai biru deep yang lebih gelap tapi tidak terlalu keras */
    box-shadow: 0 4px 0 #1D4ED8, 0 8px 20px rgba(37,99,235,.28);
    transition: transform .18s cubic-bezier(.34,1.56,.64,1), box-shadow .18s;
    letter-spacing: .3px;
}
.icard-start-btn:hover {
    transform: translateY(-3px);
    box-shadow: 0 7px 0 #1D4ED8, 0 12px 26px rgba(37,99,235,.38);
}
.icard-start-btn:active {
...
@media (max-width: 820px) {
    ...
    .qcard-head-inner{padding:10px 14px;}
    .qcard-mission{font-size:11.5px;} .qcard-counter-num{font-size:17px;}
    .qcard-question{padding:16px 14px 0;gap:9px;} .q-text{font-size:14px;}
    .qcard-opts{grid-template-columns:1fr;gap:8px;padding:14px 14px 4px;}
    .qcard-hint{padding:8px 14px 12px;}
