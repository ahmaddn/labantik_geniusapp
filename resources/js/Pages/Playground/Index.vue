                            ...
                            <div class="ic-row">
                                <div class="info-card ic-mini ic-blue">
                                    ...
                                    <div class="ic-mini-body">
                                        <span class="ic-mini-val">{{
                                            learningModules.length
                                        }}</span>
                                        <span class="ic-mini-lbl"
                                            >Total Modul</span
                                        >
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            <div class="card-body">
                                ...
                                <button
                                    ...
                                    :style="
                                        !mod.has_attempt && !mod.fully_completed
                                            ? `--btnbg:${accent(i)}`
                                            : ''
                                    "
...
.root::before {
    ...
    background:
        radial-gradient(
            ellipse 90% 70% at 10% 5%,
            rgba(30, 64, 175, 0.78) 0%,
            transparent 55%
        ),
        radial-gradient(
            ellipse 75% 60% at 90% 95%,
            rgba(29, 78, 216, 0.72) 0%,
            transparent 55%
        ),
        rgba(30, 58, 138, 0.65);
...
@keyframes hb-rise {
    ...
    100% {
        transform: translateY(-200px) translateX(var(--sway, 8px));
        opacity: 0;
    }
}
.hb-1 {
...
.ic-blue .ic-mini-icon {
    color: #93c5fd;
}
.ic-green {
    border-color: rgba(52, 211, 153, 0.35);
}
.ic-green .ic-mini-icon {
    color: #6ee7b7;
}
.ic-purple {
    border-color: rgba(167, 139, 250, 0.35);
}
.ic-purple .ic-mini-icon {
    color: #c4b5fd;
}
